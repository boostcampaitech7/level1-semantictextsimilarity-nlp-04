...
class Trainer(BaseTrainer):
    ...
    def _train_epoch(self, epoch):
        ...
        total_loss = 0
        for (data, target) in tqdm(self.train_dataloader, total=len(self.train_dataloader),
    ...
    def _valid_epoch(self, epoch):
        ...
        outputs, targets = [], []
        with torch.no_grad():
            for (data, target) in tqdm(self.valid_dataloader, total=len(self.valid_dataloader),
