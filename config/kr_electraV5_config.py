...
"""
snunlp/KR-ELECTRA-discriminator(모델) + AugmentationV5(데이터) Config 
"""

krelectraV5_data_config = DataConfig(dataloader=BaseDataloader,
                                model_name='snunlp/KR-ELECTRA-discriminator',
                                dataset=Dataset,
                                batch_size=32,#32
                                shuffle=True,
                                train_path='/data/ephemeral/home/gayeon2/data/train_augmentV5.csv',
...
krelectraV5_model_config = ModelConfig(model=BaseModel,
                                 model_name='snunlp/KR-ELECTRA-discriminator',
...
krelectraV5_trainer_config = TrainerConfig(seed=42,
                                     epoch=1, # 11,
                                     save_path='/data/ephemeral/home/gayeon2/model/snunlp-KR-ELECTRA-discriminator-V5.pt',
                                     precision=32, # 32
                                     callbacks= None,
                                     strategy='auto') 


krelectraV5_inference_config = InferenceConfig(predict_path='/data/ephemeral/home/gayeon2/result/snunlp-KR-ELECTRA-discriminator-V5.csv',
                                                model_path = '/data/ephemeral/home/gayeon2/model/snunlp-KR-ELECTRA-discriminator-V5.pt',
