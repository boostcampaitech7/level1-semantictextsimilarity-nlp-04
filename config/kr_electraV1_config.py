...
krelectraV1_data_config = DataConfig(dataloader=BaseDataloader,
                                ...
                                batch_size=32,
                                shuffle=True,
                                train_path='/data/ephemeral/home/gayeon2/config/train_augmentV1.csv',
                                dev_path='/data/ephemeral/home/gayeon2/data/dev.csv',
                                test_path='/data/ephemeral/home/gayeon2/data/dev.csv',
                                predict_path='/data/ephemeral/home/gayeon2/data/test.csv'
                                )
...
krelectraV1_trainer_config = TrainerConfig(seed=0,
                                     epoch=15, # 15,
                                     save_path='/data/ephemeral/home/gayeon2/model/snunlp-KR-ELECTRA-discriminator-V1.pt',
                                     precision=32, # precision 32 맞는지 확인
                                     callbacks= None,
                                     strategy='auto')  

krelectraV1_inference_config = InferenceConfig(predict_path='/data/ephemeral/home/gayeon2/result/snunlp-KR-ELECTRA-discriminator-V1(2).csv',
                                         model_path = '/data/ephemeral/home/gayeon2/model/snunlp-KR-ELECTRA-discriminator-V1.pt',
                                         submission_path='/data/ephemeral/home/gayeon2/data/sample_submission.csv',
                                         ensemble_weight = 0.9228
                                         )
