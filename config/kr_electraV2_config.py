...
krelectraV2_data_config = DataConfig(dataloader=BaseDataloader,
                                ...
                                batch_size=32,#32
                                shuffle=True,
                                train_path='/data/ephemeral/home/gayeon2/config/train_augmentV2.csv',
...
krelectraV2_trainer_config = TrainerConfig(seed=42,
                                     epoch=11, # 11,
                                     save_path='/data/ephemeral/home/gayeon2/model/snunlp-KR-ELECTRA-discriminator-V2.pt',
                                     precision=32, # 32
                                     callbacks= None,
                                     strategy='auto') 


krelectraV2_inference_config = InferenceConfig(predict_path='/data/ephemeral/home/gayeon2/result/snunlp-KR-ELECTRA-discriminator-V2(2).csv',
                                                model_path = '/data/ephemeral/home/gayeon2/model/snunlp-KR-ELECTRA-discriminator-V2.pt',
                                                submission_path='/data/ephemeral/home/gayeon2/data/sample_submission.csv',
                                                ensemble_weight = 0.9244
                                                )