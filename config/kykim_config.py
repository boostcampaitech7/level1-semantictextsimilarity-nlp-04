...
kykim_trainer_config = TrainerConfig(seed=42,
                                     epoch=23, # 23,
                                     save_path='/data/ephemeral/home/gayeon2/model/kykim-electra-kor-base.pt',
                                     precision=32, # 32
                                     callbacks= None,
                                     strategy='auto'
                                     ) 

kykim_inference_config = InferenceConfig(predict_path='/data/ephemeral/home/gayeon2/result/kykim-electra-kor-base(2).csv',
                                         model_path = '/data/ephemeral/home/gayeon2/model/kykim-electra-kor-base.pt',
                                         submission_path='/data/ephemeral/home/gayeon2/data/sample_submission.csv',
                                         ensemble_weight = 0.9243
                                         )