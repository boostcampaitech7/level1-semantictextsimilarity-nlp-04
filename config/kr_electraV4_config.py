...
"""
snunlp/KR-ELECTRA-discriminator(모델) + AugmentationV4(데이터) Config 
"""

krelectraV4_data_config = DataConfig(dataloader=BaseDataloader,
                                model_name='snunlp/KR-ELECTRA-discriminator',
                                dataset=Dataset,
                                batch_size=32,#32
                                shuffle=True,
                                train_path='/data/ephemeral/home/gayeon2/data/train_augmentV4.csv',
...
krelectraV4_model_config = ModelConfig(model=BaseModel,
                                 model_name='snunlp/KR-ELECTRA-discriminator',
...
krelectraV4_trainer_config = TrainerConfig(seed=42,
                                     epoch=11, # 11,
                                     save_path='/data/ephemeral/home/gayeon2/model/snunlp-KR-ELECTRA-discriminator-V4.pt',
                                     precision=32, # 32
                                     callbacks= None,
                                     strategy='auto') 


krelectraV4_inference_config = InferenceConfig(predict_path='/data/ephemeral/home/gayeon2/result/snunlp-KR-ELECTRA-discriminator-V4.csv',
                                                model_path = '/data/ephemeral/home/gayeon2/model/snunlp-KR-ELECTRA-discriminator-V4.pt',
                                                submission_path='/data/ephemeral/home/gayeon2/data/sample_submission.csv',
                                                ensemble_weight = 0.92130
                                                )